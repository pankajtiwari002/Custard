...
import 'package:custard_flutter/components/EmojiContainer.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() => Stack(
          children: [
            InkWell(
              onTap: controller.isRecording.value
                  ...
                  : () {
                      ...
                      } else if (controller.selectedMessage.length != 0) {
              ...
              onLongPress: controller.isRecording.value
                  ? null
                  : () {
                      if (!controller.focusNode.hasFocus) {
                        ...
                        if (controller.selectedMessage
                          ...
                          controller.totalSelected.value =
                              controller.totalSelected.value + 1;
                          controller.emojiVisible.value =
                              messages[index].value["messageId"];
                        }
                      }
                    },
              child: Container(
                ...
                child: Container(
                  ...
                  child: Row(
                    mainAxisAlignment: messages[index].value["from"] ==
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: messages[index].value['type'] == "LOCATION"
                            ? Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Container(
                                  ...
                                  Text(
                                    'Manipal Univeristy Jaipur, Jaipur,\nRajasthan',
                                    style: TextStyle(
                            ...
                            : messages[index].value['type'] == "DOCUMENT"
                                ? Row(
                                    children: [
                                      IconButton(
                                          onPressed: () async {
                                            downloadAndOpenPdf(messages[index]
                                                .value["document"]);
                                          },
                                          icon: Icon(
                                                              ...
                                                              LinearProgressIndicator(
                                                                ...
                                                                valueColor:
                                                                    AlwaysStoppedAnimation(
                                                                        Color(
                                                                            0xFF7B61FF)),
                                                                value: controller.recordingMessageId ==
                                                                ...
                                                                onPressed:
                                                                  ...
                                                                  if (messages[
                                                                    ...
                                                                    if (!alreadyVoted(
                                                                      ...
                                                                      for (int i =
                                                                              0;
                                                                          i < messages[index].value['pollOptions'].length;
                                                                          i++) {
                                                                        if (messages[index].value['pollOptions'][i]['uids'] !=
                                                                                null &&
                                                                            messages[index].value['pollOptions'][i]['uids'].contains(mainController.currentUser!.uid)) {
                                                                          choosenOption = messages[index]
                                                                              .value['pollOptions'][i]['uids']
                                                                              .toList();
                                                                          choosenOption.remove(mainController
                                                                              .currentUser!
                                                                              .uid);
                                                                          ind1 =
                                                                              i;
            ...
            Obx(
              () {
                if (controller.emojiVisible.value ==
                    messages[index].value["messageId"]) {
                  return EmojiView(
                    messages: messages,
                    index: index,
